...
elif value > 400 and ask[1] < 40: ## over $400 but no overtime
    tax = 0.28
    wTax = tax * value
    plusTax = value - wTax
    print("Trial ", plusTax)
if value > 400 and ask[1] > 40: ## over $400 with overtime
    tax = 0.28
    wTax = (original + overTime) * tax  
    plusTax = abs(wTax - (original + overTime))
    print("Here is your take home pay with a tax rate of 28 %: ", "$",plusTax)
elif value <= 400 and ask[1] < 40: ## under $400 with no overtime
    tax = 0.20    
    wTax = (original + overTime) * tax  
    plusTax = abs(wTax - (original + overTime))
